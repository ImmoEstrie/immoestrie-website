            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-white rounded-2xl border border-surface-variant p-6 md:p-8 mb-10 shadow-card">
                ...
                <ol className="space-y-2 font-body-md text-body-sm text-on-surface-variant list-decimal list-inside">
                  <li>
                    <a href="#collecte" className="hover:text-primary transition-colors">
                      Données collectées
                    </a>
                  </li>
                  <li>
                    <a href="#utilisation" className="hover:text-primary transition-colors">
                      Utilisation de vos données
                    </a>
                  </li>
                  <li>
                    <a href="#partage" className="hover:text-primary transition-colors">
                  ...
                  <li>
                    <a href="#droits" className="hover:text-primary transition-colors">
                      Vos droits
                    </a>
                  </li>
                  <li>
                    <a href="#securite" className="hover:text-primary transition-colors">
                      Sécurité
                    </a>
                  </li>
                </ol>
                ...
                <div className="space-y-10 font-body-md text-body-md leading-relaxed text-on-surface-variant">
                  <section id="collecte" className="scroll-mt-28">
                    ...
                    <ul className="list-disc pl-6 space-y-2 mt-4 marker:text-primary">
                      <li>
                        <span className="font-semibold text-[#1a2744]">Identité et contact :</span> nom, adresse
                        courriel, téléphone, adresse postale.
                      </li>
                      <li>
                        <span className="font-semibold text-[#1a2744]">Gestion locative :</span> informations sur le
                        bail, l&apos;immeuble, les paiements, les demandes de service via Plexflow.
                      </li>
                      <li>
                        <span className="font-semibold text-[#1a2744]">Navigation :</span> adresse IP, type
                        d&apos;appareil, pages visitées, via témoins essentiels.
                      </li>
                    </ul>
                  </section>
                  ...
                  <section id="utilisation" className="scroll-mt-28">
                    ...
                    <div className="w-12 h-[3px] bg-accent-gold-dark rounded-full mb-6" aria-hidden="true" />
                    <p>
                      Vos données servent exclusivement à exécuter nos services, à vous répondre et à améliorer votre
                      expérience — jamais à des fins de revente.
                    </p>
                    <ul className="list-disc pl-6 space-y-2 mt-4 marker:text-primary">
