...
export default function SplashScreen({ onComplete, duration = 800 }: SplashScreenProps) {
  useEffect(() => {
      ...
      >
        ...
        >
          ...
          <div className="w-16 h-16 md:w-20 md:h-20">
            <svg viewBox="0 0 165 165" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
              <path
          ...
          <div className="text-center">
            <p
              className="font-display text-blue-600 text-base md:text-lg tracking-wide"
              style={{ fontFamily: "var(--font-playfair, serif)" }}
            >
              Gestion Immobilière
            </p>
            <p
              className="font-display text-slate-900 text-base md:text-lg tracking-wide -mt-0.5"
              style={{ fontFamily: "var(--font-playfair, serif)" }}
            >
              de l&apos;Estrie
            </p>
