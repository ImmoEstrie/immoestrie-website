...
export default function TopBar() {
  return (
    <div className="w-full bg-[radial-gradient(ellipse_at_top,_#1e3a5f_0%,_#1a2744_35%,_#0f172a_65%,_#020617_100%)] text-white h-9 flex items-center overflow-hidden fixed top-0 inset-x-0 z-[60]">
      {/* ===== Mobile layout : telephone a gauche, email a droite ===== */}
      <div className="flex sm:hidden items-center justify-between w-full px-4">
        <a
          href="tel:+18199754599"
          className="inline-flex items-center gap-1.5 text-xs font-semibold whitespace-nowrap hover:opacity-80 transition-opacity"
          aria-label="Appeler au +1 819 975 4599"
        >
          <Phone className="w-3.5 h-3.5 text-[#22c55e] shrink-0" aria-hidden="true" />
      ...
      {/* ===== Desktop / tablette layout : version complete centree ===== */}
      <div className="hidden sm:flex items-center justify-center gap-9 w-full px-4 flex-wrap">
        <a
          href="tel:+18199754599"
